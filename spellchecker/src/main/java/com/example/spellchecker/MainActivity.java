        ...
        if (!etText.getText().toString().isEmpty()) {
            ...
            if (spellCheckerSession != null) {
                spellCheckerSession.getSentenceSuggestions(
                        new TextInfo[]{new TextInfo(etText.getText().toString())}, 5);//5 表示给出的备选项个数
            } else {
